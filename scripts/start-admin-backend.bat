...
set "PORT=8082"
set "SERVICE=admin-service backend"
...
call mvnw.cmd -s .mvn/settings.xml -f admin-service/backend/pom.xml spring-boot:run -DskipTests -Dspring-boot.run.arguments="--server.address=0.0.0.0"
